...
import NormalCaurols from "./NormalCaurols";
import ContainerSliderCaursal from "./ContainerSliderCaursal";
...
export default function DottedCaursol() {
  return (
    <View style={styles.container}>
      <NormalCaurols data={images} />
    </View>
  );
}
